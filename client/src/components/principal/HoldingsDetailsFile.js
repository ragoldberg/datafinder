...
const HoldingsDetailsFile = ({
  ...
  useEffect(() => {
    if (!resultados_holdings) return;

    cnae_primario = {
      code: formatDocument(resultados_holdings[0].cnae_primario),
      description: resultados_holdings[0].nome,
    };

    if (resultados_holdings[0].cnae_secundario_full) {
      const cnae_secundario_cods = resultados_holdings[0].cnae_secundario_full
        .split("-")[0]
        .split(",");
      const cnae_secundario_descs = resultados_holdings[0].cnae_secundario_full
        .split("-")[1]
        .split(",");
        ...
        <div className="details-icon">
          <div class="Icon">
            <img
              ...
              src={resultados_holdings[0].logo_url}
        ...
        <div className="details-title-container">
          <div className="details-title-razao-cnpj">
            <p className="details-title-razao">
              {arrumatexto(resultados_holdings[0].razao_social)}
            </p>

            <p className="details-title-cnpj">
              {formatDocument(resultados_holdings[0].cnpj)}
            </p>
          </div>
          ...
          <div className="details-title-main">
            <div className="results-row-cnae-container4">
              <p className="cnae-title">
                {arrumatexto(resultados_holdings[0].nome_fantasia) || " - "}
              </p>
            ...
            <div className="details-title-status">
              <span>
                {mat_fil_extenso(
                  resultados_holdings[0].nm_matriz_filial.split(" ")[0]
                )}
              </span>
              <span>
                {sit_cad_extenso(
                  resultados_holdings[0].situacao_cadastral_nome
                )}
              </span>
            </div>
          </div>
          ...
          <div className="details-title-location">
            <p className="details-title-municipio">
              {arrumatexto(resultados_holdings[0].municipio)}
            </p>
            <p className="details-title-uf">
              {arrumatexto(states[resultados_holdings[0].uf].name)}
            </p>
          </div>
        </div>
        <section id="gigs">
                    ...
                    <div className="details-inner-left-description">
                      <div className="details-grid-five">
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {resultados_holdings[0].description || "-"}
                          </p>
                        </span>
                      </div>
                      ...
                      <div className="details-grid-one">
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {resultados_holdings[0].data_inicio || "-"}
                          </p>
                        </span>
                        <span>
                          <p className="details-inner-left-description-title">
                        ...
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {resultados_holdings[0].num_funcionarios || "-"}
                          </p>
                        </span>
                        <span>
                          <p className="details-inner-left-description-title">
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(
                              resultados_holdings[0].natureza_juridica
                            ) || "-"}
                          </p>
                        </span>
                      </div>
                      ...
                      <div className="details-grid-two">
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(resultados_holdings[0].porte) || "-"}
                          </p>
                        </span>
                        <span>
                          <p className="details-inner-left-description-title">
                        ...
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(
                              resultados_holdings[0].simples_nacional
                            ) || "-"}
                          </p>
                        </span>
                        {/*					<div className="details-grid-five">
												<span>
													...
													<p className="details-inner-left-description-subtitle">{resultados_holdings[0].acoes || "-"}</p>
												</span>
											</div> */}
                      </div>
                    </div>
                    ...
                    <div className="details-inner-left-description">
                      <div className="details-grid-three">
                        ...
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {resultados_holdings[0].email.toLowerCase() || "-"}
                          </p>
                        </span>
                        <span>
                          <p className="details-inner-left-description-title">
                      ...
                      <div className="details-grid-four">
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(
                              resultados_holdings[0].descricao_tipo_logradouro
                            )}{" "}
                            {arrumatexto(resultados_holdings[0].logradouro)},{" "}
                            {resultados_holdings[0].numero}, Bairro{" "}
                            {arrumatexto(resultados_holdings[0].bairro)}, CEP -{" "}
                            {formatDocument(resultados_holdings[0].cep)},{" "}
                            {resultados_holdings[0].municipio} -{" "}
                            {resultados_holdings[0].uf}
                          </p>
                    ...
                    <div className="details-sede-capital">
                      <div className="details-sede-container">
                        ...
                        <div className="details-sede-description">
                          <h3>Subsidiarias</h3>
                          <h2>
                            {resultados_holdings[0].qtd_subsidiarias || "-"}
                          </h2>
                        </div>
                      </div>
                      ...
                      <div className="details-capital-container">
                        ...
                        <div className="details-capital-description">
                          <h3>Filiais</h3>
                          <h2>{resultados_holdings[0].Filiais || "-"}</h2>
                        </div>
                      </div>
                    </div>
                  </div>
