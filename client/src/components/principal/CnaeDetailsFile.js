...
const CnaeDetailsFile = ({
  ...
  useEffect(() => {
    if (!resultados_cnae) return;

    cnae_primario = {
      code: formatDocument(resultados_cnae[0].cnae_primario),
      description: resultados_cnae[0].nome,
    };

    if (resultados_cnae[0].cnae_secundario_full) {
      const cnae_secundario_cods = resultados_cnae[0].cnae_secundario_full
        .split("-")[0]
        .split(",");
      const cnae_secundario_descs = resultados_cnae[0].cnae_secundario_full
        .split("-")[1]
        .split(",");
  ...
  console.log("/resultados_cnae/", resultados_cnae);
  console.log("/resultados_leads/", resultados_leads);
  console.log("/socios_cnae/", socios_cnae);
        ...
        <div className="details-icon">
          <div class="Icon">
            <img
              ...
              src={resultados_cnae[0].logo_url}
        ...
        <div className="details-title-container">
          <div className="details-title-razao-cnpj">
            <p className="details-title-razao">
              {arrumatexto(resultados_cnae[0].razao_social)}
            </p>

            <p className="details-title-cnpj">
              {formatDocument(resultados_cnae[0].cnpj)}
            </p>
          </div>
          ...
          <div className="details-title-main">
            <div className="results-row-cnae-container4">
              <p className="cnae-title">
                {arrumatexto(resultados_cnae[0].nome_fantasia) || " - "}
              </p>
            ...
            <div className="details-title-status">
              <span>
                {mat_fil_extenso(
                  resultados_cnae[0].nm_matriz_filial.split(" ")[0]
                )}
              </span>
              <span>
                {sit_cad_extenso(resultados_cnae[0].situacao_cadastral_nome)}
              </span>
            </div>
          </div>
          <div className="details-title-separator" />
          <div className="details-title-location">
            <p className="details-title-municipio">
              {arrumatexto(resultados_cnae[0].municipio)}
            </p>
            <p className="details-title-uf">
              {arrumatexto(states[resultados_cnae[0].uf].name)}
            </p>
          </div>
        </div>
        <section id="gigs">
            ...
            <div style={{ maxHeight: "90vh", margin: 0 }}>
              <div className="details-inner-container">
                    ...
                    <div className="details-inner-left-description">
                      ...
                      <div className="details-grid-one">
                        ...
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {resultados_cnae[0].num_funcionarios || "-"}
                          </p>
                        </span>
                        <span>
                          <p className="details-inner-left-description-title">
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(
                              resultados_cnae[0].natureza_juridica
                            ) || "-"}
                          </p>
                        </span>
                      </div>
                      ...
                      <div className="details-grid-two">
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(resultados_cnae[0].porte) || "-"}
                          </p>
                        </span>
                        <span>
                          <p className="details-inner-left-description-title">
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {resultados_cnae[0].microempreendedor_individual ||
                              "-"}
                          </p>
                        </span>
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(resultados_cnae[0].simples_nacional) ||
                              "-"}
                          </p>
                        </span>
                        {/*					<div className="details-grid-five">
												<span>
													...
													<p className="details-inner-left-description-subtitle">{resultados_cnae[0].acoes || "-"}</p>
												</span>
											</div> */}
                      </div>
                    </div>
                    ...
                    <div className="details-inner-left-description">
                      <div className="details-grid-three">
                        <span>
                          ...
                          <span className="details-inner-left-description-subtitle details-phone">
                            ...
                            <p>{resultados_cnae[0].ddd_telefone_1}</p>
                            <p>{resultados_cnae[0].ddd_telefone_2}</p>
                          </span>
                        </span>
                        <span></span>
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {resultados_cnae[0].email.toLowerCase() || "-"}
                          </p>
                        </span>
                        <span>
                          <p className="details-inner-left-description-title">
                      ...
                      <div className="details-grid-four">
                        <span>
                          ...
                          <p className="details-inner-left-description-subtitle">
                            {arrumatexto(
                              resultados_cnae[0].descricao_tipo_logradouro
                            )}{" "}
                            {arrumatexto(resultados_cnae[0].logradouro)},{" "}
                            {resultados_cnae[0].numero}, Bairro{" "}
                            {arrumatexto(resultados_cnae[0].bairro)}, CEP -{" "}
                            {formatDocument(resultados_cnae[0].cep)},{" "}
                            {resultados_cnae[0].municipio} -{" "}
                            {resultados_cnae[0].uf}
                          </p>
                ...
                <div className="details-inner-right-container">
                    ...
                    <div className="details-sede-capital">
                      <div className="details-sede-container">
                        ...
                        <div className="details-sede-description">
                          <h3>Filiais</h3>
                          <h2>{resultados_cnae[0].filiais}</h2>
                        </div>
                      </div>
                      ...
                      <div className="details-capital-container">
                        ...
                        <div className="details-capital-description">
                          ...
                          <h2>
                            {resultados_cnae[0].capital.toLocaleString(
                              "pt-BR",
                              {
                                style: "currency",
                                currency: "BRL",
                  ...
                  {socios_cnae && socios_cnae.length > 0 && (
                            ...
                            >
                              ...
                              <div className="details-socio-content">
                                ...
                                <div className="details-socio-info-container">
                                  ...
                                  >
                                    {socio.aux_emergencial_recebido}{" "}
                                  </span>
                                </div>
                              </div>
                            </div>
...
export default memo(CnaeDetailsFile);
